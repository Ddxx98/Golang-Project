...
export default function Register(){
    ...
    const Submit = async(e)=>{
        ...
        console.log(user)
        axios.post("http://localhost:8080/register",{name,email,phone,state,district,address,pincode,password},{
            headers:{
            ...
            <div className='register_main'>
                <div className='register_left'>
                    <div className='register_top'>
                        <h1 className='h-tag'>E Commerce</h1>
                        <p className='p-tag'>Doorstep Service</p>
                    </div>
